  ...
  async postAddUser(req, res) {
    ...
    if (
      ...
      try {
        ...
        if (save) {
          return res.json({ success: "Tạo tài khoản thành công" });
        }
      } catch (err) {
  ...
  async postEditUser(req, res) {
    ...
    if (!uId || !name || !phoneNumber) {
      ...
      currentUser.exec((err, result) => {
        ...
        return res.json({ success: "Cập nhật tài khoản thành công" });
      });
    }
  }
      ...
      if (!data) {
        ...
        if (oldPassCheck) {
          ...
          passChange.exec((err, result) => {
            if (err) console.log(err);
            return res.json({ success: "Cập nhật mật khẩu thành công" });
          });
        } else {
          return res.json({
            error: "Mật khẩu cũ của bạn không đúng!",
          });
        }
      }
    }
