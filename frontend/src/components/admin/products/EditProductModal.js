...
const EditProductModal = (props) => {
  ...
  const submitForm = async (e) => {
    ...
    if (!editformData.pEditImages) {
      console.log("Tải ảnh không thành công", editformData);
    } else {
        ...
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col mt-4">
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={`http://localhost:8000/uploads/products/${editformData.pImages[0]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={`http://localhost:8000/uploads/products/${editformData.pImages[1]}`}
                    alt="productImage"
                  />
                </div>
              ) : (
              ...
              <span className="text-gray-600 text-xs">Cần tối thiểu 2 ảnh</span>
              <input
                onChange={(e) =>
                  setEditformdata({
                    ...editformData,
            ...
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                ...
                <select
                  ...
                  id="status"
                >
                  <option name="status" value="Hoạt động">
                    Hoạt động
                  </option>
                  <option name="status" value="Ẩn">
                    Ẩn
                  </option>
                </select>
              </div>
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="status">Loại sản phẩm *</label>
                <select
                  onChange={(e) =>
                    setEditformdata({
                      ...editformData,
            ...
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="quantity">Số lượng tại cửa hàng *</label>
                <input
              ...
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="offer">Ưu đãi sản phẩm (%) *</label>
                <input
