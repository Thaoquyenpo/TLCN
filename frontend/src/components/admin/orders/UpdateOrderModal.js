        ...
        <div className="relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
          ...
          <div className="flex flex-col space-y-1 w-full">
            ...
            <select
              ...
              id="status"
            >
              <option name="status" value="Chưa xử lý">
              Chưa xử lý
              </option>
              <option name="status" value="Đang xử lý">
                Đang xử lý
              </option>
              <option name="status" value="Đang giao hàng">
                Đang giao hàng
              </option>
              <option name="status" value="Đã giao hàng">
                Đã giao hàng
              </option>
              <option name="status" value="Đã hủy">
                Đã hủy
              </option>
            </select>
          </div>
