        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="hidden md:block md:col-span-1 md:flex md:flex-col md:space-y-4 md:mr-2">
            <img
              ...
              src={`http://localhost:8000/uploads/products/${sProduct.pImages[0]}`}
              alt="pic"
            />
            <img
              onClick={(e) =>
              ...
              src={`http://localhost:8000/uploads/products/${sProduct.pImages[1]}`}
              alt="pic"
            />
          </div>
          <div className="col-span-2 md:col-span-7">
            <div className="relative">
              <img
                className="w-full"
                src={`http://localhost:8000/uploads/products/${sProduct.pImages[count]}`}
                alt="Pic"
              />
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              <div className="text-2xl tracking-wider">{sProduct.pName} <span> {} --- Sale {sProduct.pOffer} %</span></div>
              <div className="flex justify-between items-center">
                <span className="text-xl tracking-wider text-yellow-700">
                  {formatter.format(sProduct.pPrice)}
                </span>
                <span>
                  <svg
            ...
            <div className="my-4 md:my-6">
              {+quantitiy === +sProduct.pQuantity ? (
                <span className="text-xs text-red-500">Đã đạt đến giới hạn số lượng trong kho</span>
              ) : (
                ""
              )}
              <div
