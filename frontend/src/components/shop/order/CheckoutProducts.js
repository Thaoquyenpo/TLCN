...
import momo from "../image/momo.jpg";
    ...
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {products !== null && products.length > 0 ? (
              ...
              >
                <div className="md:flex md:items-center md:space-x-4">
                  ...
                  <div className="md:ml-6 font-semibold text-gray-600 text-sm">
                    Giá : {formatter.format(product.pPrice)}{" "}
                  </div>
                  <div className="md:ml-6 font-semibold text-gray-600 text-sm">
                    Sale : {formatter.format(product.pPrice*product.pOffer/100)}{" "}
                  </div>
                  <div className="md:ml-6 font-semibold text-gray-600 text-sm">
                    Số lượng : {quantity(product._id)} Chiếc
                  </div>
                  <div className="font-semibold text-gray-600 text-sm">
                    Tổng giá : {formatter.format(subTotal(product._id, product.pPrice - product.pPrice*product.pOffer/100))}
                  </div>
                </div>
              </div>
            );
          ...
          <div> Chưa có sản phẩm nào để tiến hành thành toán</div>
        )}
      </div>
    </Fragment>
  );
